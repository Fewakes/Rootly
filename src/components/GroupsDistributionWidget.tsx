...
import { getAllGroupsWithContactCounts } from '@/pages/Groups';
...
// ✨ PAGINATION: Define how many items to show per page in the widget
...
export const GroupsDistributionWidget = () => {
  ...
  // ✨ PAGINATION: Add state for the current page
  ...
  // Get the subset of groups to display for the current page
  ...
  const renderContent = () => {
    ...
    return (
      // ✨ REMOVED: Scrollbar classes are no longer needed
  ...
  return (
    <Card>
      ...
      {/* ✨ FOOTER: Redesigned footer with pagination controls */}
